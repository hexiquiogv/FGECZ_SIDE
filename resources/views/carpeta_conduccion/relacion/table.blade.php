<table class="table table-striped table-hover table-responsive caption-top">
    <caption>Listado de imputados-delitos-víctimas</caption>    
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>NOEMI ZAPATA REYNA</td>
      <td>Fraude</td>
      <td>JUAN HILARIO LEDEZMA MONTELONGO</td>
      <td>
        <a class="btn btn-outline-primary btn-sm" href="#" role="button">Ver</a>
