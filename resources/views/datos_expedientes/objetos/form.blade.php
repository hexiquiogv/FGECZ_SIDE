<form method='post' name="frmDE_O" id="frmDE_O" action="{{ route('save') }}" enctype="multipart/form-data">
  ...
  <input type="hidden" name="Ctrl" id="Ctrl" value="{{$Ctrl}}">
	<div class="row DEobjetos">
	 <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		  <label for="objeto_objeto_1" class="form-label">Objeto 1:</label>
		  <select class="form-select noValidate noVacios" name="objeto_objeto_1" id="objeto_objeto_1">
			<option value="-1">Seleccione una opción</option>
		 </select>
		</div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_desc_obj_1" class="form-label">Descripción :</label>
		<input type="text" class="form-control alfanum noValidate obj1" maxlength="255" name="objeto_desc_obj_1" id="objeto_desc_obj_1" placeholder="">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_cant_obj_1" class="form-label">Cantidad:</label>
		<input type="text" class="form-control alfanum noValidate obj1" name="objeto_cant_obj_1" id="objeto_cant_obj_1" placeholder="">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_valor_obj_1" class="form-label">Valor aproximado:</label>
		<input type="text" class="form-control valor noValidate obj1" name="objeto_valor_obj_1" id="objeto_valor_obj_1" placeholder="">
	  </div>
	 	<div class="mb-3 col-sm-12 col-md-6 col-lg-4">
	 ...
	 <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		  <label for="objeto_objeto_2" class="form-label">Objeto 2:</label>
		  <select class="form-select noValidate noVacios" name="objeto_objeto_2" id="objeto_objeto_2">
			<option value="-1">Seleccione una opción</option>
		 </select>
		</div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_desc_obj_2" class="form-label">Descripción :</label>
		<input type="text" class="form-control alfanum noValidate obj2" maxlength="255" name="objeto_desc_obj_2" id="objeto_desc_obj_2" placeholder="">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_cant_obj_2" class="form-label">Cantidad:</label>
		<input type="text" class="form-control alfanum noValidate obj2" name="objeto_cant_obj_2" id="objeto_cant_obj_2" placeholder="">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_valor_obj_2" class="form-label">Valor aproximado:</label>
		<input type="text" class="form-control valor noValidate obj2" name="objeto_valor_obj_2" id="objeto_valor_obj_2" placeholder="">
	  </div>
	 	<div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		  ...
		  <select class="form-select noValidate obj2" name="objeto_estatus_obj_2" id="objeto_estatus_obj_2">
			...
			<div class="mb-4 col-12"><hr></div>
	 <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		  <label for="objeto_objeto_3" class="form-label">Objeto 3:</label>
		  <select class="form-select noValidate noVacios" name="objeto_objeto_3" id="objeto_objeto_3">
			<option value="-1">Seleccione una opción</option>
		 </select>
		</div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_desc_obj_3" class="form-label">Descripción :</label>
		<input type="text" class="form-control alfanum noValidate obj3" maxlength="255" name="objeto_desc_obj_3" id="objeto_desc_obj_3" placeholder="">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_cant_obj_3" class="form-label">Cantidad:</label>
		<input type="text" class="form-control alfanum noValidate obj3" name="objeto_cant_obj_3" id="objeto_cant_obj_3" placeholder="">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_valor_obj_3" class="form-label">Valor aproximado:</label>
		<input type="text" class="form-control valor noValidate obj3" name="objeto_valor_obj_3" id="objeto_valor_obj_3" placeholder="">
	  </div>
	 	<div class="mb-3 col-sm-12 col-md-6 col-lg-4">
...
<script type="text/javascript">
	...
	@for ($i = 1; $i <= 3; $i++)
		$("#objeto_objeto_{{$i}}").change(function(){
	...
	$(function() {
		@for ($i = 1; $i <= 3; $i++)
				if ($("#objeto_objeto_{{$i}}").val()>-1) { $(".obj{{$i}}").removeClass('noValidate'); }
				else
				{ $(".obj{{$i}}").addClass('noValidate'); $(".obj{{$i}}").removeClass("border-3 border-danger");}
