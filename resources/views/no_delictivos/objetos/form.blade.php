  ...
  <input type="hidden" name="Ctrl" id="Ctrl" value="{{$Ctrl}}">
	<div class="row objetos">
		<div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		  <label for="nodObjeto_objeto_1" class="form-label">Objeto 1:</label>
		  <select class="form-select noValidate noVacios" name="nodObjeto_objeto_1" id="nodObjeto_objeto_1">
			<option value="-1">Seleccione una opción</option>
		 </select>
		</div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_desc_obj_1" class="form-label">Descripción :</label>
		<input type="text" class="form-control alfanum noValidate obj1" name="nodObjeto_desc_obj_1" id="nodObjeto_desc_obj_1" placeholder="">
	  </div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_cant_obj_1" class="form-label">Cantidad:</label>
		<input type="text" class="form-control alfanum noValidate obj1" name="nodObjeto_cant_obj_1" id="nodObjeto_cant_obj_1" placeholder="">
	  </div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_valor_obj_1" class="form-label">Valor aproximado:</label>
		<input type="text" class="form-control valor noValidate obj1" name="nodObjeto_valor_obj_1" id="nodObjeto_valor_obj_1" placeholder="">
	  </div>
		...
		<div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		  <label for="nodObjeto_objeto_2" class="form-label">Objeto 2:</label>
		  <select class="form-select noValidate noVacios" name="nodObjeto_objeto_2" id="nodObjeto_objeto_2">
			<option value="-1">Seleccione una opción</option>
		 </select>
		</div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_desc_obj_2" class="form-label">Descripción :</label>
		<input type="text" class="form-control alfanum noValidate obj2" name="nodObjeto_desc_obj_2" id="nodObjeto_desc_obj_2" placeholder="">
	  </div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_cant_obj_2" class="form-label">Cantidad:</label>
		<input type="text" class="form-control alfanum noValidate obj2" name="nodObjeto_cant_obj_2" id="nodObjeto_cant_obj_2" placeholder="">
	  </div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_valor_obj_2" class="form-label">Valor aproximado:</label>
		<input type="text" class="form-control valor noValidate obj2" name="nodObjeto_valor_obj_2" id="nodObjeto_valor_obj_2" placeholder="">
	  </div>
	 	<div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		  ...
		  <select class="form-select noValidate obj2" name="objeto_estatus_obj_2" id="objeto_estatus_obj_2">
			...
			<div class="mb-2 col-12"><hr></div>
		<div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		  <label for="nodObjeto_objeto_3" class="form-label">Objeto 3:</label>
		  <select class="form-select noValidate noVacios" name="nodObjeto_objeto_3" id="nodObjeto_objeto_3">
			<option value="-1">Seleccione una opción</option>
		 </select>
		</div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_desc_obj_3" class="form-label">Descripción :</label>
		<input type="text" class="form-control alfanum noValidate obj3" name="nodObjeto_desc_obj_3" id="nodObjeto_desc_obj_3" placeholder="">
	  </div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_cant_obj_3" class="form-label">Cantidad:</label>
		<input type="text" class="form-control alfanum noValidate obj3" name="nodObjeto_cant_obj_3" id="nodObjeto_cant_obj_3" placeholder="">
	  </div>
	  <div class="mb-1 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_valor_obj_3" class="form-label">Valor aproximado:</label>
		<input type="text" class="form-control valor noValidate obj3" name="nodObjeto_valor_obj_3" id="nodObjeto_valor_obj_3" placeholder="">
	  </div>
	 	<div class="mb-3 col-sm-12 col-md-6 col-lg-4">
	 ...
	 <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
	  ...
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		...
		<div class="mb-4 col-12"><hr></div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_estatus_no_delictivos" class="form-label">Estatus del vehículo:</label>
		<!-- <input type="text" class="form-control nonum" name="nodObjeto_estatus_no_delictivos" id="nodObjeto_estatus_no_delictivos" placeholder=""> -->
	   <select class="form-select noValidate noVacios" name="nodObjeto_estatus_no_delictivos" id="nodObjeto_estatus_no_delictivos">
			<option value="-1">Seleccione una opción</option>
		 </select>	
	  </div>
	  ...
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_marca_no_delictivos" class="form-label">Marca:</label>
		<input type="text" class="form-control nonum noValidate vehiculo" name="nodObjeto_marca_no_delictivos" id="nodObjeto_marca_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_modelo_no_delictivos" class="form-label">Modelo:</label>
		<input type="text" class="form-control alfanum noValidate vehiculo" name="nodObjeto_modelo_no_delictivos" id="nodObjeto_modelo_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_color_no_delictivos" class="form-label">Color:</label>
		<input type="text" class="form-control nonum noValidate vehiculo" name="nodObjeto_color_no_delictivos" id="nodObjeto_color_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_tipo_no_delictivos" class="form-label">Tipo:</label>
		<input type="text" class="form-control nonum noValidate vehiculo" name="nodObjeto_tipo_no_delictivos" id="nodObjeto_tipo_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_placa_no_delictivos" class="form-label">Placa:</label>
		<input type="text" class="form-control alfanum noValidate vehiculo" name="nodObjeto_placa_no_delictivos" id="nodObjeto_placa_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_numero_no_delictivos" class="form-label">Número de serie:</label>
		<input type="text" class="form-control alfanum noValidate vehiculo" name="nodObjeto_numero_no_delictivos" id="nodObjeto_numero_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="nodObjeto_estado_placas_no_delictivos" class="form-label">Estado de las placas:</label>
		<input type="text" class="form-control nonum noValidate vehiculo" name="nodObjeto_estado_placas_no_delictivos" id="nodObjeto_estado_placas_no_delictivos">
	  </div>
	  <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
		<label for="objeto_lugar_vehiculo_no_delictivos" class="form-label">Lugar donde se encuentra el vehículo:</label>
		<input type="text" class="form-control alfanum noValidate" name="objeto_lugar_vehiculo_no_delictivos" id="objeto_lugar_vehiculo_no_delictivos">
	  </div>
...
$(".valor").mask("#,##0.00",{reverse: true});
	...
	@for ($i = 1; $i <= 3; $i++)
		$("#nodObjeto_objeto_{{$i}}").change(function(){
	...
	$(function() {
		@for ($i = 1; $i <= 3; $i++)
				if ($("#nodObjeto_objeto_{{$i}}").val()>-1) { $(".obj{{$i}}").removeClass('noValidate'); }
				else
				{ $(".obj{{$i}}").addClass('noValidate'); $(".obj{{$i}}").removeClass("border-3 border-danger");}
	...
	$("#nodObjeto_estatus_no_delictivos").change(function(){
